      ...
      <div className="w-full md:flex md:justify-center md:pointer-events-auto">
        <div className="eris-page-inner w-full max-w-[100%] px-6 pb-6 pt-8 md:max-w-[85%] md:px-[5rem] md:pb-[1.5rem] md:pt-[3rem]">
          <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
            ...
            <nav
              className="flex w-full shrink-0 items-center justify-start gap-4 md:w-auto md:justify-end"
              aria-label="Social links"
            >
              <a
                href="https://github.com/SamIAm2000"
                target="_blank"
                rel="noopener noreferrer"
                className="eris-icon-link inline-flex shrink-0"
                aria-label="GitHub"
              >
                <svg className="h-[2rem] w-[2rem]" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                  <path
                    fillRule="evenodd"
              ...
              <a
                href="https://www.instagram.com/lookiehere___/"
                target="_blank"
                rel="noopener noreferrer"
                className="eris-icon-link inline-flex shrink-0"
              ...
              <a
                href="https://www.linkedin.com/in/erisgao/"
                target="_blank"
                rel="noopener noreferrer"
                className="eris-icon-link inline-flex shrink-0"
                aria-label="LinkedIn"
